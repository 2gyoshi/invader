...
/***/ "./src/script/controler/controler.js":
/*!*******************************************!*\
  !*** ./src/script/controler/controler.js ***!
  \*******************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _util_utility__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util/utility */ \"./src/script/util/utility.js\");\n/* harmony import */ var _view_field__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view/field */ \"./src/script/view/field.js\");\n/* harmony import */ var _view_background__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./view/background */ \"./src/script/view/background.js\");\n/* harmony import */ var _model_factory__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./model/factory */ \"./src/script/model/factory.js\");\n/* harmony import */ var _model_game_manager__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/game_manager */ \"./src/script/model/game_manager.js\");\n/* harmony import */ var _view_view_manager__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./view/view_manager */ \"./src/script/view/view_manager.js\");\n/* harmony import */ var _controler_swipe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./controler/swipe */ \"./src/script/controler/swipe.js\");\n/* harmony import */ var _controler_touch__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./controler/touch */ \"./src/script/controler/touch.js\");\n/* harmony import */ var _controler_keydown__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./controler/keydown */ \"./src/script/controler/keydown.js\");\n/* harmony import */ var _controler_event__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./controler/event */ \"./src/script/controler/event.js\");\n/* harmony import */ var _controler_controler__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./controler/controler */ \"./src/script/controler/controler.js\");\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nfunction main() {\n    const utility   = new _util_utility__WEBPACK_IMPORTED_MODULE_0__[\"Utility\"]();\n    const viewField = new _view_field__WEBPACK_IMPORTED_MODULE_1__[\"Field\"]();\n    const viewSpace = new _view_background__WEBPACK_IMPORTED_MODULE_2__[\"Background\"](utility);\n    const factory   = new _model_factory__WEBPACK_IMPORTED_MODULE_3__[\"Factory\"](utility, viewField);\n    const modelMngr = new _model_game_manager__WEBPACK_IMPORTED_MODULE_4__[\"GameManager\"](utility, factory);\n    const viewMngr  = new _view_view_manager__WEBPACK_IMPORTED_MODULE_5__[\"ViewManager\"](viewSpace, viewField);\n    const swipe     = new _controler_swipe__WEBPACK_IMPORTED_MODULE_6__[\"Swipe\"](modelMngr);\n    const touch     = new _controler_touch__WEBPACK_IMPORTED_MODULE_7__[\"Touch\"](modelMngr);\n    const keydown   = new _controler_keydown__WEBPACK_IMPORTED_MODULE_8__[\"Keydown\"](modelMngr);\n    const event     = new _controler_event__WEBPACK_IMPORTED_MODULE_9__[\"Event\"](keydown, swipe, touch);\n    const controler = new _controler_controler__WEBPACK_IMPORTED_MODULE_10__[\"Controler\"](utility, modelMngr, viewMngr, event);\n\n    const domStrBtn = document.querySelector('#js-start-btn');\n    const domStpBtn = document.querySelector('#js-stop-btn');\n    const domRstBtn = document.querySelector('#js-reset-btn');\n    domStrBtn.addEventListener('click', controler.start.bind(controler));\n    domStpBtn.addEventListener('click', controler.stop.bind(controler));\n    domRstBtn.addEventListener('click', controler.reset.bind(controler));\n    domStrBtn.addEventListener('touchstart', controler.start.bind(controler));\n    domStpBtn.addEventListener('touchstart', controler.stop.bind(controler));\n    domRstBtn.addEventListener('touchstart', controler.reset.bind(controler));\n    window.addEventListener('load',   () => controler.init());\n    window.addEventListener('resize', () => controler.resize());\n}\n\nmain();\n\n//# sourceURL=webpack:///./src/script/main.js?");

/***/ }),

/***/ "./src/script/model/bullet.js":
/*!************************************!*\
  !*** ./src/script/model/bullet.js ***!
  \************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Enemy\", function() { return Enemy; });\n/* harmony import */ var _character__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./character */ \"./src/script/model/character.js\");\n\n\n\n\nclass Enemy extends _character__WEBPACK_IMPORTED_MODULE_0__[\"NonPlayerCharacter\"] {\n    constructor(field, status, position, look) {\n        super(field, status, position, look);\n    }\n\n    update() {\n        super.update();\n\n        const fy = this.field.getTop();\n        const fh = this.field.getHeight()\n        const max = (fy + fh) * 0.8;\n        if(this.position.getY() > max) this.dead();\n    }\n}\n\n\n//# sourceURL=webpack:///./src/script/model/enemy.js?");

/***/ }),

/***/ "./src/script/model/factory.js":
/*!*************************************!*\
  !*** ./src/script/model/factory.js ***!
  \*************************************/
