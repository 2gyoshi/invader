...
function main() {
    ...
    const charaList = maf.createList();
    const mCharaMgr = maf.createCharaMgr(charaList, mcf)
    ...
    const mGameMgr  = new MA_GameMgr(mRuleMgr, mCharaMgr, mScoreMgr, mTimeMgr, mStateMgr);
